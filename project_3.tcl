...
################################################################
# This is a generated script based on design: adc2gsps_bd
#
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.mADC_Decimation_Mode00 {4} \
    CONFIG.mADC_Dither00 {true} \
    CONFIG.mADC_Nyquist00 {0} \
    CONFIG.mADC_PLL_Enable {true} \
    CONFIG.mADC_Sampling_Rate {2} \
    CONFIG.mADC_Slice00_Enable {true} \
  ...
  connect_bd_intf_net -intf_net adc0_clk_1_1 [get_bd_intf_ports adc0_clk_1] [get_bd_intf_pins usp_rf_data_converter_0/adc0_clk]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins usp_rf_data_converter_0/s_axi]
  connect_bd_intf_net -intf_net sysref_in_1 [get_bd_intf_ports sysref_in] [get_bd_intf_pins usp_rf_data_converter_0/sysref_in]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins usp_rf_data_converter_0/m00_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD] [get_bd_intf_pins axi_smc_1/S00_AXI]
